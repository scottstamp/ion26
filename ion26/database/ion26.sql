...
CREATE TABLE `catalog_pages` (
  ...
  `layout_headline` varchar(50) NOT NULL,
  `layout_images` varchar(50) NOT NULL,
  `layout_description` varchar(50) NOT NULL,
  `layout_description_side` varchar(50) NOT NULL,
  `layout_extra` varchar(50) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `catalog_pages` VALUES ('2', '2', '1', 'collectibles', 'Collectibles', 'ctlg_layout2', '', '', '', '', '');
INSERT INTO `catalog_pages` VALUES ('3', '3', '1', 'fruniz', 'Fruniz Shop', 'ctlg_layout2', '', '', '', '', '');
INSERT INTO `catalog_pages` VALUES ('4', '1', '1', 'spaces', 'Spaces', 'ctlg_layout2', '', '', '', '', '');
INSERT INTO `catalog_pages` VALUES ('5', '2', '1', 'windows', 'Windows', 'ctlg_layout2', '', '', '', '', '');
INSERT INTO `catalog_pages` VALUES ('6', '3', '1', 'accessories', 'Accessories', 'ctlg_layout2', 'catalog_extra_headline1', 'catalog_extra_teaser1,', 'Det er pyntetingene og de sm̴ finessene som forte', 'Klikk p̴ en ting for flere detaljer', 's:2: I love my rabbit...');
INSERT INTO `catalog_pages` VALUES ('7', '4', '1', 'mode', 'Mode', 'ctlg_layout2', '', '', '', '', '');
INSERT INTO `catalog_pages` VALUES ('8', '5', '1', 'pura', 'Pura', 'ctlg_layout2', '', '', '', '', '');
INSERT INTO `catalog_pages` VALUES ('9', '6', '1', 'plants', 'Plants', 'ctlg_layout2', '', '', '', '', '');
INSERT INTO `catalog_pages` VALUES ('10', '7', '1', 'secret', 'Secret', 'ctlg_layout2', '', '', '', '', '');
...
-- ----------------------------
INSERT INTO `catalog_products` VALUES ('1', '6', '1', '6');
...
-- ----------------------------
INSERT INTO `furniture_templates` VALUES ('1', 'rare_parasol*0', '1', 'Cool parasol', 'Its so pretty!', '#ffffff,#ffffff,#fff', '1', '1', '0', '0', '0');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('3', 'awa', '1', '7', '2010-04-01', 'a@a.com', '1-1-1990', '=D', 'hd-180-59', 'm', '1232', '1', '2', '111', '23-03-2010 07:37:54 ');
