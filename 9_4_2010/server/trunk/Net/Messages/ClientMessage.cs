...
namespace Ion.Net.Messages
{
    ...
    public class ClientMessage : IHabboMessage
    {
        ...
        /// <summary>
        /// Reads a b64 format boolean and returns it. False is returned if there is no remaining content.
        /// </summary>
        /// <returns>Boolean</returns>
        public Boolean PopB64Boolean()
        {
            return (this.remainingContent > 0 && mContent[mContentCursor++] == Base64Encoding.POSITIVE);
        }
        /// <summary>
        ...
        public UInt32 PopWiredUInt32()
        {
            ...
            byte[] bzData = this.ReadBytesFreezeCursor(WireEncoding.MAX_INTEGER_BYTE_AMOUNT);
            Int32 totalBytes = 0;
            UInt32 i = (uint)WireEncoding.DecodeInt32(bzData, out totalBytes);
            mContentCursor += totalBytes;
