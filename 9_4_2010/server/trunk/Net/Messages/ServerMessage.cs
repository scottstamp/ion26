...
namespace Ion.Net.Messages
{
    public class ServerMessage : IHabboMessage
    {
        ...
        /// <summary>
        /// Appends a character to the message content.
        /// </summary>
        /// <param name="c">The character number to append.</param>
        public void AppendChar(int c)
        {
            mContent.Add((byte)Convert.ToChar(c));
        }
        ...
        public void AppendString(object s, byte Breaker)
        {
            Append(s.ToString()); // Append string with default encoding
