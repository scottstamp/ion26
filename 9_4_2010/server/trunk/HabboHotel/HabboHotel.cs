...
namespace Ion.HabboHotel
{
    ...
    public class HabboHotel
    {
        ...
        private NavigatorManager mNavigatorManager = null;
        ...
        public HabboHotel()
        {
            ...
            mNavigatorManager = new NavigatorManager();
            ...
            mNavigatorManager.ReloadCategories();

            // Load room models
            mModelManager.ReloadModels();
        ...
        /// <summary>
        /// Returns the NavigatorManager instance.
        /// </summary>
